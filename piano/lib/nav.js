...
(function(){
  ...
  var LESSONS=[
    ...
    {t:'Les 4 accords de The Scientist',     f:'accord-mineur-et-the-scientist.html', k:'Harmonie',
     d:"Reconnaître la couleur mineure à l'oreille, puis enchaîner les 4 accords."},
    ...
    {t:'Le rythme : de la pulsation aux croches', f:'rythme-jouer-en-mesure.html', k:'Rythme',
     d:"Tenir le tempo, puis remplir les temps en croches — quatre paliers."},
